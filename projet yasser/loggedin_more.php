...
View Profile</li></a>
  ...
  <a href="logout_more.php?logout=true" class="nounderline"><li class="list-group-item"><span class="glyphicon glyphicon-log-out"></span><i class="fas fa-sign-out-alt"></i>
